window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第9行",
        "detail": "9 |     char log_msg[BUF_SIZE] = \"Sensor: \";",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第12行",
        "detail": "12 |     printf(\"After strcat 1: %s\\n\", log_msg);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第15行",
        "detail": "15 |     printf(\"After strcat 2: %s\\n\", log_msg);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
  ...
  "hint": "strcat在字符串末尾追加，目标缓冲区必须足够大。",
  "analysis": "- 第5行：缓冲区大小\n- 第9行：初始字符串\n- 🔥 第11行：追加\"Temp=\"\n- 第14行：追加\"25C\"\n- 第12-15行：打印中间结果"
};
