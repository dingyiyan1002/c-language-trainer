window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第8行",
        "detail": "8 |     uint8_t gpio_output = 0x00;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第11行",
        "detail": "11 |     printf(\"Toggle 1: 0x%02X\\n\", gpio_output);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第14行",
        "detail": "14 |     printf(\"Toggle 2: 0x%02X\\n\", gpio_output);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第17行",
        "detail": "17 |     printf(\"Toggle 3: 0x%02X\\n\", gpio_output);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
  ...
  "hint": "异或运算：相同为0，不同为1。^=翻转特定位。",
  "analysis": "- 第4行：LED引脚定义\n- 第8行：GPIO输出初始值\n- 🔥 第10行：异或翻转LED，0→1\n- 第13行：异或翻转LED，1→0\n- 第16行：异或翻转LED，0→1"
};
