window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第4行",
        "detail": "4 | #define ENABLE_UART   (1U << 0)",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第5行",
        "detail": "5 | #define ENABLE_SPI    (1U << 1)",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第6行",
        "detail": "6 | #define ENABLE_I2C    (1U << 2)",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第10行",
        "detail": "10 |     uint8_t peripheral_en = 0x00;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第12行",
        "detail": "12 |     peripheral_en |= ENABLE_UART;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第13行",
        "detail": "13 |     printf(\"After UART: 0x%02X\\n\", peripheral_en);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第15行",
        "detail": "15 |     peripheral_en |= ENABLE_SPI;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第16行",
        "detail": "16 |     printf(\"After SPI: 0x%02X\\n\", peripheral_en);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第18行",
        "detail": "18 |     peripheral_en |= ENABLE_I2C;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第19行",
        "detail": "19 |     printf(\"After I2C: 0x%02X\\n\", peripheral_en);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
  ...
  "hint": "|=运算设置特定位为1，不影响其他位。",
  "analysis": "- 第4-6行：定义外设使能位\n- 第10行：初始值0\n- 🔥 第12行：|=设置UART位，结果0x01\n- 第15行：|=设置SPI位，结果0x03\n- 第18行：|=设置I2C位，结果0x07"
};
