window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第12行",
        "detail": "12 |     for (uint8_t i = 0, j = 10; i < j; i++, j--) {",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
