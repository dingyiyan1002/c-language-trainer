window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第6行",
        "detail": "6 |     uint8_t frame_header = 0xAA;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第7行",
        "detail": "7 |     uint8_t frame_len    = 0x05;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第8行",
        "detail": "8 |     uint8_t frame_data[] = {0x01, 0x02, 0x03, 0x04, 0x05};",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第11行",
        "detail": "11 |     printf(\"%02X \", frame_header);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第12行",
        "detail": "12 |     printf(\"%02X \", frame_len);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第14行",
        "detail": "14 |     for (uint8_t i = 0; i < frame_len; i++) {",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第15行",
        "detail": "15 |         printf(\"%02X \", frame_data[i]);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
  ...
  "hint": "多个printf连续调用，输出会拼接在一起，直到遇到\\n才换行。",
