window.LESSON_DATA = {
  ...
  "hint": "宏是文本替换，SQUARE(b++)展开后b会自增几次？",
  "analysis": "- 第4行：定义平方宏，参数加括号\n- 第5行：定义加倍宏\n- 第10行：SQUARE(5) = 25，正常\n- 🔥 第13行：SQUARE(b++)展开为((b++)*(b++))\n- 第13行：b++执行两次，结果是未定义行为\n- 第14行：b最终值不确定"
};
