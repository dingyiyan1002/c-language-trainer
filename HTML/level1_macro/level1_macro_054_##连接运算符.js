window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第4行",
        "detail": "4 | #define REG(name)  REG_##name",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第5行",
        "detail": "5 | #define GPIO_REG  0x40020000",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第6行",
        "detail": "6 | #define UART_REG  0x40011000",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第8行",
        "detail": "8 | #define FUNC(name)  void func_##name(void) { printf(#name \"\\n\"); }",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
