window.LESSON_DATA = {
  "meta": {
    ...
    "title": "数据结构面试题",
    "index": 3,
    "filename": "interview_003_interview-3.js",
    "keyPoints": [
      "链表反转",
      "栈与队列",
      "二叉树遍历",
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第18行",
        "detail": "Node n1 = {1, NULL}, n2 = {2, NULL}, n3 = {3, NULL};",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第20行",
        "detail": "Node* new_head = reverse(&n1);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第22行",
        "detail": "for (Node* p = new_head; p; p = p->next)",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
