window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第8行",
        "detail": "8 |     uint8_t frame[FRAME_LEN] = {0xAA, 0x55, 0x01, 0x02, 0x03, 0x00};",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第11行",
        "detail": "11 |     for (uint8_t i = 0; i < FRAME_LEN - 1; i++) {",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第16行",
        "detail": "16 |     frame[FRAME_LEN - 1] = checksum;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第18行",
        "detail": "18 |     printf(\"Checksum: 0x%02X\\n\", checksum);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第20行",
        "detail": "20 |     for (uint8_t i = 0; i < FRAME_LEN; i++) {",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
