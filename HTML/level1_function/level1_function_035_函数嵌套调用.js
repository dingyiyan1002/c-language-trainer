window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第4行",
        "detail": "4 | uint16_t adc_read(void)",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第9行",
        "detail": "9 | uint16_t adc_to_voltage(uint16_t adc_value)",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第11行",
        "detail": "11 |     return (adc_value * 3300) / 4095;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第16行",
        "detail": "16 |     uint16_t voltage = adc_to_voltage(adc_read());",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
