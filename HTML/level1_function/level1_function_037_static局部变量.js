window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第4行",
        "detail": "4 | void log_message(const char *msg)",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第6行",
        "detail": "6 |     static uint32_t call_count = 0;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第13行",
        "detail": "13 |     log_message(\"System init\");",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第14行",
        "detail": "14 |     log_message(\"Device ready\");",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第15行",
        "detail": "15 |     log_message(\"Start working\");",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
