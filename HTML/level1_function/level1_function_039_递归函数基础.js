window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第4行",
        "detail": "4 | uint32_t factorial(uint8_t n)",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第9行",
        "detail": "9 |     return n * factorial(n - 1);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第14行",
        "detail": "14 |     uint32_t result = factorial(5);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
