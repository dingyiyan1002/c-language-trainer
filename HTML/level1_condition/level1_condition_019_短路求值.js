window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第6行",
        "detail": "6 |     uint8_t sensor_valid = 1;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第7行",
        "detail": "7 |     int16_t sensor_value = -10;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第10行",
        "detail": "10 |     if (sensor_valid && sensor_value > 0) {",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第11行",
        "detail": "11 |         printf(\"Valid positive\\n\");",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第13行",
        "detail": "13 |         printf(\"Invalid or non-positive\\n\");",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第16行",
        "detail": "16 |     if (data_ready || sensor_valid) {",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第17行",
        "detail": "17 |         printf(\"Data available\\n\");",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
