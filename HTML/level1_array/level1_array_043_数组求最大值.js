window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第8行",
        "detail": "8 |     uint16_t data[DATA_LEN] = {150, 320, 80, 450, 200, 380};",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第9行",
        "detail": "9 |     uint16_t max_value = data[0];",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第12行",
        "detail": "12 |     for (uint8_t i = 1; i < DATA_LEN; i++) {",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第19行",
        "detail": "19 |     printf(\"Max: %u at index %u\\n\", max_value, max_index);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
