window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第8行",
        "detail": "8 |     uint16_t buffer[BUF_SIZE] = {100, 200};",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第10行",
        "detail": "10 |     for (uint8_t i = 0; i < BUF_SIZE; i++) {",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
