window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第8行",
        "detail": "8 |     uint8_t data[DATA_LEN] = {5, 3, 5, 8, 5, 2, 8, 5};",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第11行",
        "detail": "11 |     int8_t first_index = -1;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第22行",
        "detail": "22 |     printf(\"Target %u appears %u times\\n\", target, count);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第23行",
        "detail": "23 |     printf(\"First appearance at index %d\\n\", first_index);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
