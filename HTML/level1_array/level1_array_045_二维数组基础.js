window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第16行",
        "detail": "16 |     printf(\"Size: %zu bytes\\n\", sizeof(matrix));",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
  ...
  "hint": "二维数组按行优先存储，matrix[i][j]访问第i行第j列。",
  "analysis": "- 第4-5行：行列数定义\n- 第9-12行：二维数组初始化\n- 第14行：访问第一行第一列，值1\n- 第15行：访问第二行第三列，值6\n- 🔥 第16行：sizeof得到整个数组大小6字节"
};
