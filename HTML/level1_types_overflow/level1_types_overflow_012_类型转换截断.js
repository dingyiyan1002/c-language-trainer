window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第4行",
        "detail": "4 | #define ADC_MAX_VALUE   4095",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第5行",
        "detail": "5 | #define PERCENT_MAX     100",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第10行",
        "detail": "10 |     uint8_t  percentage = 0;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第12行",
        "detail": "12 |     percentage = (adc_value * PERCENT_MAX) / ADC_MAX_VALUE;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第18行",
        "detail": "18 |     percentage = (adc_value * PERCENT_MAX) / ADC_MAX_VALUE;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    },
    {
      ...
      "explanation": {
        "text": "执行第19行",
        "detail": "19 |     printf(\"Max percentage: %u%%\\n\", percentage);",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
