window.LESSON_DATA = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第9行",
        "detail": "9 |     uint8_t packet_seq = 254;",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
    ...
    },
    {
      ...
      "explanation": {
        "text": "执行第11行",
        "detail": "11 |     for (uint8_t i = 0; i < MAX_RETRY; i++) {",
        "actor": "CPU",
        "icon": "bolt",
        "color": "green"
      }
