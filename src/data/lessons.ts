...
class B {
    ...
    options: [
      { id: 'A', text: 'std::shared_ptr<A> a_ptr;' },
      { id: 'B', text: 'std::weak_ptr<A> a_ptr;' },
      { id: 'C', text: 'std::unique_ptr<A> a_ptr;' },
      { id: 'D', text: 'A* a_ptr;' }
    ],
    correctAnswer: ['A'],
    multiCorrect: false,
  ...
  // ========== C++ 核心难点 - 移动语义 ==========
  {
    ...
    chapter: 'advanced-cpp',
    type: 'choice',
    title: 'std::move 的本质是什么？',
    description: '移动语义理解',
    options: [
      { id: 'A', text: '移动资源' },
      { id: 'B', text: '将左值转换为右值引用' },
      { id: 'C', text: '调用移动构造函数' },
      { id: 'D', text: '释放资源' }
    ],
    correctAnswer: 'B',
...
std::vector<int> v2 = std::move(v1);`,
  ...
  // ========== C++ 核心难点 - 虚函数与多态 ==========
  {
    ...
    chapter: 'advanced-cpp',
    type: 'choice',
    title: '为什么基类的析构函数应该是虚函数？',
    description: '虚析构函数的作用',
    options: [
      { id: 'A', text: '为了语法正确' },
      { id: 'B', text: '防止内存泄漏' },
      { id: 'C', text: '提高性能' },
...
p->f();`,
  ...
  },
  {
    ...
    chapter: 'advanced-cpp',
    type: 'choice',
    title: '多重继承下，派生类对象包含几个 vptr？',
    description: '多重继承的虚函数表',
...
void foo(T t);`,
  ...
  // ========== C++ 核心难点 - 内存模型 ==========
  {
    ...
    description: '内存序比较',
    options: [
      { id: 'A', text: 'memory_order_relaxed' },
      { id: 'B', text: 'memory_order_acquire' },
      { id: 'C', text: 'memory_order_release' },
      { id: 'D', text: 'memory_order_seq_cst' }
    ],
    correctAnswer: 'D',
